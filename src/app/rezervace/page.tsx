                ...
                {ARTISTS.map(a=>(
                  <motion.button key={a.id} whileTap={{scale:0.98}} onClick={()=>setForm(f=>({...f,artistId:a.id}))}
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center font-serif text-xl flex-shrink-0"
                        style={{background:'linear-gradient(135deg,#C4698A,#FF6BA8)',color:'white'}}>{a.initial}</div>
                      <div>
